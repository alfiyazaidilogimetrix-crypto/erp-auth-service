...
export declare const createHeadOfficeDoc: {
    tags: string[];
    method: "post";
    path: "/";
    summary: string;
...
export declare const getHeadOfficesDoc: {
    tags: string[];
    method: "get";
    path: "/";
    summary: string;
            ...
            content: {
                'application/json': {
                    schema: z.ZodObject<{
                        status: z.ZodNumber;
                        message: z.ZodString;
                        headOffices: z.ZodArray<z.ZodObject<{
                            id: z.ZodNumber;
                            company_id: z.ZodNumber;
                            office_name: z.ZodString;
                            office_id: z.ZodString;
...
export declare const getHeadOfficeByIdDoc: {
    tags: string[];
    method: "get";
    path: "/{id}";
    summary: string;
...
export declare const updateHeadOfficeDoc: {
    tags: string[];
    method: "patch";
    path: "/{id}";
    summary: string;
...
export declare const deleteHeadOfficeDoc: {
    tags: string[];
    method: "delete";
    path: "/{id}";
    summary: string;
