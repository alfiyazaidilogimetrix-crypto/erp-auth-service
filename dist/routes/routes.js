...
var headOffice_1 = require("./headOffice/headOffice");
var branchOffice_1 = require("./branchOffice/branchOffice");
...
routes.route('/company', company_1.default);
routes.route('/head-office', headOffice_1.default);
routes.route('/branch-office', branchOffice_1.default);
