...
exports.authenticationMiddleware = (0, factory_1.createMiddleware)(function (c, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authHeader, token, payload, userId, user, error_1;
        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                if (!user) {
                    ...
                    throw new http_exception_1.HTTPException(401, { message: 'Unauthorized: User not found' });
                }
            ...
            case 5:
                error_1 = _a.sent();
                console.error('Authentication error details:', error_1);
                throw new http_exception_1.HTTPException(401, {
