...
var createPermission = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var modules, permission;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                if (!(body.moduleIds && body.moduleIds.length > 0)) return [3 /*break*/, 2];
