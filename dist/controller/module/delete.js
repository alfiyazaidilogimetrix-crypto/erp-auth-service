...
var deleteModule = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    var module;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, erp_shared_models_1.prisma.module.delete({
                        where: { id: id },
                    })];
            case 2:
                _a.sent();
                return [2 /*return*/, { message: 'Module deleted successfully' }];
        }
    });
}); };
