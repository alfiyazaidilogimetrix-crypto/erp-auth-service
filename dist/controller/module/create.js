...
var createModule = function (body) { return __awaiter(void 0, void 0, void 0, function () {
    var existingModule, module;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, erp_shared_models_1.prisma.module.findFirst({
            ...
            case 1:
                ...
                return [4 /*yield*/, erp_shared_models_1.prisma.module.create({
                        data: body,
                        include: {
                            permissions: {
                                include: {
