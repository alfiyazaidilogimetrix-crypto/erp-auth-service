...
var updateRole = function (id, body) { return __awaiter(void 0, void 0, void 0, function () {
    var role, existingRole, permissions, updatedRole;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                if (!(body.name && body.name !== role.name)) return [3 /*break*/, 3];
            ...
            case 2:
                ...
                _a.label = 3;
            case 3:
                if (!(body.permissionIds && body.permissionIds.length > 0)) return [3 /*break*/, 5];
            ...
            case 4:
                ...
                _a.label = 5;
            case 5: return [4 /*yield*/, erp_shared_models_1.prisma.role.update({
                    where: { id: id },
                    data: {
                        name: body.name,
                        ...
                        permissions: body.permissionIds
                            ? {
                                set: body.permissionIds.map(function (id) { return ({ id: id }); }),
                            }
                            : undefined,
                    },
                    include: {
